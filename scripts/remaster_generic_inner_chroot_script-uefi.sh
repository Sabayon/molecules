...
equo repo enable sabayon-limbo || exit 1
equo update sabayon-limbo || exit 1
echo "http://pkg.sabayon.org" >> /var/lib/entropy/client/database/amd64/sabayon-limbo/standard/amd64/5/packages.db.mirrors
equo install grub --relaxed || exit 1
